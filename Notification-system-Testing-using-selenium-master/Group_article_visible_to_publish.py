...
class signup(unittest.TestCase):
	...
	def test_visisbleToPublishState(self):	
		driver = self.driver
		self.login(1) # logging in with publisher since from visible state, article can be published or rejected only by users who have roles like publisher/group_admin/community_admin
